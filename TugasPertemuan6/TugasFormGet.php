...
<html lang="en">
    ...
    <body>
        ...
        <tr>
        <th style="background-color: purple;" colspan="2">BLOK I : KETERANGAN TEMPAT USAHA</th>
        </tr>
        <tr>
        ...
        <table border="1" cellspacing="0" cellpadding="12" width= "100%">
            <tr>
                <th style="background-color: purple;" colspan="2">BLOK II : IDENTITAS USAHA</th>
            </tr>    
            <tr>
            ...
            <td align="left">a. Jenis Perairan</td>
                ...
                <table border="1" cellspacing="0" cellpadding="12" width= "100%">
                    <tr>
                        <th style="background-color: purple;" colspan="2">BLOK III : PRODUKSI PERIKANAN TANGKAP</th>
                    </tr>
                    <tr>
                ...
                <table border="1" cellspacing="0" cellpadding="12" width= "100%">
                    <tr>
                        <th style="background-color: purple;" colspan="2">BLOK IV : PENGESAHAN</th>
                    </tr>
                    <tr>
