...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Viantika Permita Novita, Serang Banten.</li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2021 Viantika Permita Novita. All rights reserved</p>
			</div>
		</div>
